    ...
    public function getPlano(Request $request){
      ...
      foreach ($request->sucursalesFiltradas as $key => $sucursal) {
        ...
        $data = [
          ...
          'cuentaremitente' => '7777777',
          'sederemitente' => 'SANTIAGO DE CALI',
          'primernombreremitente' => 'BELLEZA',
          'segundonombreremitente' => 'EXPRESS SA',
          'primerapellidoremitente'=> '',
          'segundoapellidoremitente'=> '',
          'razonsocialremitente'=> 'BELLEZA EXPRESS SA',
