    ...
    <form name="nivelesEditForm" ng-submit="nivelesEditForm.$valid && editarNivel()" novalidate>
      <div class="modal-content panel-primary">
        ...
        <div class="modal-header panel-heading">
          ...
          <h4 class="modal-title">Editar Nivel de Aprobación - @{{usuarioUno != undefined ? infoPerNivel.nivel.niv_descripcion : nivel[0].niv_descripcion}}</h4>
        </div>
          ...
          <md-tabs md-dynamic-height md-border-bottom>
            <md-tab label="informacion general">
              <md-content class="md-padding">
                ...
                <div class="panel panel-primary" ng-if="infoPerNivel.territorio != undefined || infoPerNivel.canales != undefined || infoPerNivel.grupos != undefined">
