            ...
            <md-content class="md-padding">
                <table datatable="ng" dt-options="dtOptions" dt-column-defs="dtColumnDefs" class="row-border hover">
                  ...
                  <tbody ng-repeat="apro in aprobadas">
                    ...
                    <td>
                      <button type="button" class="btn btn-primary" ng-click="generarPdf(apro.solIntSolId)">
            ...
            <md-content class="md-padding">
              <table datatable="ng" dt-options="dtOptions" dt-column-defs="dtColumnDefs" class="row-border hover">
                ...
                <tbody ng-repeat="cerr in cerradas">
                  ...
                  <td>
                    <button class="btn btn-primary" ng-click="generarPdf(cerr.solIntSolId)" type="button">
