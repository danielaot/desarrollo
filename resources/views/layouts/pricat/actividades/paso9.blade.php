...
@section('content')
  ...
  <div ng-controller="paso9Ctrl" ng-cloak>
    <form name="paso9Form" ng-submit="paso9Form.$valid && saveProducto()" class="form-horizontal" novalidate>
      <div class="panel panel-default">
        <div class="panel-body">
          ...
          @endif
          <div class="row" ng-class="{'has-error' : (errores | contains: 'ide_posarancelaria')}">
            <label class="col-sm-3 control-label">Posición Arancelaria:</label>
            <p class="col-sm-6 control-label">{{$item['detalles']['ide_posarancelaria']}} - {{$item['detalles']['posicionarancelaria']['desc_pos_arancelaria']}}</p>
          </div>
          <div class="row" ng-class="{'has-error' : (errores | contains: 'ide_grupoimpositivo')}">
            <label class="col-sm-3 control-label">Grupo Impositivo:</label>
            <p class="col-sm-6 control-label">{{$item['detalles']['ide_grupoimpositivo']}} - {{$item['detalles']['grupoimpositivo']['desc_grupoimpo']}}</p>
          </div>
          <br>
          <div class="row">
...
@push('script_angularjs')
  <script src="{{url('/js/pricat/paso9Ctrl.js')}}" type="text/javascript" language="javascript"></script>
@endpush
