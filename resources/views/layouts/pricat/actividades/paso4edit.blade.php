...
@section('content')
  ...
  <div class="panel panel-default">
    <div class="panel-body">
      ...
      @endif
      <br>
      {!! Form::open(['route' => ['paso4.edit', $item['id']], 'method' => 'PUT']) !!}
        <div class="row">
          <div class="col-sm-12">
            <div class="row">
              ...
              <div class="col-sm-6">
                <select class="form-control" name="arancelaria" required>
                  <option value="">{{$posaran[0]->id_pos_arancelaria}} - {{$posaran[0]->desc_pos_arancelaria}}</option>
        ...
        <div class="row">
          <div class="text-center">
            <input type="hidden" name="proy" value="{{$proy}}"/>
