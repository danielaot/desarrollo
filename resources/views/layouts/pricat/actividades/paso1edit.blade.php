...
@section('content')
  ...
  @if(isset($itemdet))
  <div ng-controller="paso1Ctrl" ng-cloak ng-init= "itemdet = {{$itemdet}};getInfo();">
    @else
          ...
          <div class="row">
            <div class="col-sm-5 form-group">
              <div class="row">
                ...
                <label class="col-sm-6 control-label">{{$ref}}</label>
              </div>
            </div>
          </div>
          <div class="row">
        ...
        <div class="panel-body" style="padding: 15px 0;">
          <div class="row form-group">
            <div class="col-md-6">
              ...
              <div class="col-sm-12">
                <select class="form-control" ng-model="producto.origen" ng-options="opt.descripcionItemCriterioMayor for opt in origen track by opt.idItemCriterioMayor" required>
                </select>
              </div>
